  ...
  themedAppearance = pkgs.writeText "Appearance.qml" ''
    ...
    Singleton {
      ...
      m3colors: QtObject {
          ...
          property color m3background: "#1a${c.base00}"
          property color m3onBackground: "#${c.base05}"
          property color m3surface: "#1a${c.base00}"
          property color m3surfaceContainerLow: "#26${c.base01}"
          property color m3surfaceContainer: "#33${c.base01}"
          property color m3surfaceContainerHigh: "#40${c.base02}"
          property color m3surfaceContainerHighest: "#4d${c.base02}"
